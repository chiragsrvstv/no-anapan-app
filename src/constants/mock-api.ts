...
import { accounts, insights, ORG_CHART } from './seed';
import { intelligence } from './intelligence-seed';
...
export function getIntelligence(user: any) {}

export function getAccountTrends(account: any) {}

export function getAccounts(user: any) {
  return accounts;
}

export function getAccountDetails(account: any) {
  const acc = find(accounts, { id: account.id });
  return acc;
}
